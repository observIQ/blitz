...
_blitz_help()
{
    ...
    flags+=("--generator-palo-alto-rate=")
    two_word_flags+=("--generator-palo-alto-rate")
    flags+=("--generator-palo-alto-workers=")
    two_word_flags+=("--generator-palo-alto-workers")
    ...
    flags+=("--output-otlp-grpc-batchtimeout=")
    two_word_flags+=("--output-otlp-grpc-batchtimeout")
    flags+=("--output-otlp-grpc-enable-tls")
    flags+=("--output-otlp-grpc-host=")
    two_word_flags+=("--output-otlp-grpc-host")
    flags+=("--output-otlp-grpc-maxexportbatchsize=")
    two_word_flags+=("--output-otlp-grpc-maxexportbatchsize")
    flags+=("--output-otlp-grpc-maxqueuesize=")
    two_word_flags+=("--output-otlp-grpc-maxqueuesize")
    flags+=("--output-otlp-grpc-port=")
    two_word_flags+=("--output-otlp-grpc-port")
    flags+=("--output-otlp-grpc-requesttimeout=")
    two_word_flags+=("--output-otlp-grpc-requesttimeout")
    flags+=("--output-otlp-grpc-workers=")
    two_word_flags+=("--output-otlp-grpc-workers")
    ...
    flags+=("--telemetry-logs-insecure")
    flags+=("--telemetry-logs-otlpendpoint=")
    two_word_flags+=("--telemetry-logs-otlpendpoint")
    flags+=("--telemetry-traces-insecure")
    flags+=("--telemetry-traces-otlpendpoint=")
    two_word_flags+=("--telemetry-traces-otlpendpoint")
    flags+=("--telemetry-traces-perbatchspans")
