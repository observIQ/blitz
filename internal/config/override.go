...
func DefaultOverrides() []*Override {
	overrides := []*Override{
		...
		NewOverride("output.prometheus-remote-write.endpoint", "Prometheus remote-write endpoint URL", ""),
		NewOverride("output.prometheus-remote-write.version", "Prometheus remote-write protocol version. One of: 1.0|2.0", DefaultPromRWVersion),
