...
func DefaultOverrides() []*Override {
	overrides := []*Override{
		...
		NewOverride("generator.filegen.mode", "file reading mode: file or directory", "file"),
		NewOverride("generator.filegen.source", "file path, directory path, or package name", ""),
