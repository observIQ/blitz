...
func DefaultOverrides() []*Override {
	overrides := []*Override{
		...
		NewOverride("generator.type", "generator type. One of: nop|json|winevt|palo-alto|apache-common|apache-combined|apache-error|nginx|postgres|kubernetes|filegen|okta|hostmetrics", GeneratorTypeNop),
