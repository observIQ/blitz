...
func getTestOverrideFlagsArgs() []string {
	return []string{
		...
		"--generator-palo-alto-workers", "6",
		"--generator-palo-alto-rate", "750ms",
		...
		"--generator-wel-computer", "FLAG-PC",
		"--generator-wel-domain", "FLAGDOMAIN",
		"--generator-wel-role", "dc",
		"--generator-wel-manageeventsources=false",
		...
		"--output-otlp-grpc-workers", "3",
		"--output-otlp-grpc-batchtimeout", "10s",
		"--output-otlp-grpc-requesttimeout", "15s",
		"--output-otlp-grpc-maxqueuesize", "4096",
		"--output-otlp-grpc-maxexportbatchsize", "1024",
		"--output-otlp-grpc-enable-tls", "true",
		...
		"--output-prometheus-remote-write-endpoint", "http://rw.example.com/api/v1/write",
		"--output-prometheus-remote-write-version", "2.0",
...
func getTestOverrideEnvs() map[string]string {
	return map[string]string{
		...
		"BLITZ_GENERATOR_PALO_ALTO_WORKERS":                 "7",
		"BLITZ_GENERATOR_PALO_ALTO_RATE":                    "150ms",
		...
		"BLITZ_GENERATOR_WEL_COMPUTER":                      "ENV-PC",
		"BLITZ_GENERATOR_WEL_DOMAIN":                        "ENVDOMAIN",
		"BLITZ_GENERATOR_WEL_ROLE":                          "dc",
		"BLITZ_GENERATOR_WEL_MANAGEEVENTSOURCES":            "false",
		...
		"BLITZ_OUTPUT_OTLP_GRPC_HOST":                       "collector.env.example",
		"BLITZ_OUTPUT_OTLP_GRPC_PORT":                       "4318",
		"BLITZ_OUTPUT_OTLP_GRPC_WORKERS":                    "5",
		"BLITZ_OUTPUT_OTLP_GRPC_BATCHTIMEOUT":               "15s",
		"BLITZ_OUTPUT_OTLP_GRPC_REQUESTTIMEOUT":             "20s",
		"BLITZ_OUTPUT_OTLP_GRPC_MAXQUEUESIZE":               "8192",
		"BLITZ_OUTPUT_OTLP_GRPC_MAXEXPORTBATCHSIZE":         "2048",
		"BLITZ_OUTPUT_OTLP_GRPC_ENABLE_TLS":                 "true",
		"BLITZ_OUTPUT_OTLP_GRPC_TLS_INSECURE":               "false",
		"BLITZ_OUTPUT_OTLP_GRPC_TLS_CERT":                   "/env/otlp_cert.pem",
		"BLITZ_OUTPUT_OTLP_GRPC_TLS_KEY":                    "/env/otlp_key.pem",
		"BLITZ_OUTPUT_OTLP_GRPC_TLS_CA":                     "/env/otlp_ca1.pem,/env/otlp_ca2.pem",
		"BLITZ_OUTPUT_OTLP_GRPC_TLS_SKIP_VERIFY":            "false",
		"BLITZ_OUTPUT_OTLP_GRPC_TLS_MIN_VERSION":            "1.2",
		...
		"BLITZ_OUTPUT_PROMETHEUS_REMOTE_WRITE_ENDPOINT":     "http://rw-env.example.com/api/v1/write",
		"BLITZ_OUTPUT_PROMETHEUS_REMOTE_WRITE_VERSION":      "2.0",
...
func TestOverrideFlags(t *testing.T) {
	...
	t.Setenv("BLITZ_OUTPUT_OTLP_GRPC_TLS_INSECURE", "")
	t.Setenv("BLITZ_OUTPUT_OTLP_GRPC_TLS_SKIP_VERIFY", "")
	...
	expectedCfg := &Config{
		...
		Output: Output{
			...
			PrometheusRemoteWrite: PrometheusRemoteWriteOutputConfig{
				Endpoint:     "http://rw.example.com/api/v1/write",
				Version:      "2.0",
				BatchSize:    250,
				BatchTimeout: 10 * time.Second,
...
func TestOverrideEnvs(t *testing.T) {
	...
	expectedCfg := &Config{
		...
		Output: Output{
			...
			PrometheusRemoteWrite: PrometheusRemoteWriteOutputConfig{
				Endpoint:     "http://rw-env.example.com/api/v1/write",
				Version:      "2.0",
				BatchSize:    300,
				BatchTimeout: 7 * time.Second,
